...
| Status note | Rebuilt locally on 2026-06-23 from `42787c6243eba88f436b43f84df8d66aa60d5683`; local package inspection and focused 107-test release regression slice passed. Clean Windows VM smoke must be rerun for this exact hash before this refreshed asset is treated as VM-green. Mac laptop watcher refuses stale-app hidden silent install by default and labels any explicit opt-in as diagnostic-only. |
...
| Clean Windows install / VM smoke | YELLOW for refreshed installer | Previous VM smoke was GREEN for `3a43cdff49c758b07ccfd57117a06304152813a7b80d857ba99c03486fe8f4fa`; refreshed installer is `0ad45db3d1a405c47f8105720099beca220e99fb2e81c69cebb3c45b6622100e` and needs a new VM/RM run | Prior VM `clawx-win-rc-20260609`, smoke root `C:\Users\clawxtest\Downloads\clawx-vm-smoke-20260622-205920` | Codex | No passwords printed | Signed-in Microsoft tenant proof remains required for GA; exact refreshed installer VM proof pending |
