...
| LATENCY-UX | perf | "Taking real long to respond… thinking" — Raj's only twice-volunteered complaint; cost a Minister demo slot (05-27, 06-27) | Cause-side = KR6 token floor; no user-facing budget ever set | OPEN — needs p50/p90 budget row + measurement on pilot moe.14 | STAKEHOLDER_REPORT §missed |
