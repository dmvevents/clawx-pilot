...
| Current verdict | `YELLOW - prerelease candidate; clean Windows install/package smoke passed, signed-in tenant Outlook/Forms proof still required before GA` |
...
- Excel/Word/PDF and any demo PowerPoint workflow have generated-file evidence, not only dependency/package presence.
