...
## Latest diagnostic candidate — moe.25 (acceptance in progress)

Moe.25 is the latest installed diagnostic artifact: `8058e9b5b3050463c72a11c8e5da56616206f6e3`, [run 34203201042](https://github.com/dmvevents/clawx-pilot/actions/runs/34203201042). [Exact hashes and startup evidence](evidence/WINDOWS_MOE25_PLANNING_BASELINE_2026-09-08.md) bind the assisted upgrade and readiness observation to this artifact. Existing Main, fresh and next Online turns now PASS on this exact artifact; Microsoft journeys, document retests and full recovery remain open. No private moe.25 download or GA publication exists.
