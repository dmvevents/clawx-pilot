...
export const MOE_NO_HOSTAPI_TOOLS = [
  ...
  'document_write_xlsx',
  'document_read_image',
  'principal_draft_letter',
  'principal_draft_memo',
  'principal_summarise_circular',
  'principal_daily_report_payload',
  'principal_daily_report_form_payload',
  'principal_suspension_payload',
  'principal_find_school',
  'principal_nscc_lookup',
];
...
// silently when outlook_readiness landed (6ec32807) and again when
// browser_open_chrome landed (41359e12); both register inside the same
